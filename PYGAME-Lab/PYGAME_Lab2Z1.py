    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_1:
                scaled = pygame.transform.scale(image, (int(width * 0.35), int(height * 0.35)))
                win.fill(CZARNY)
                ...
                scale = pygame.transform.scale(image, (int(width * 0.35), height))
                ...
                top_scaled = pygame.transform.scale(image, (width, int(height * 0.35)))
                win.fill(CZARNY)
                win.blit(top_scaled, ((width - top_scaled.get_width()) // 2, 1))
                pygame.display.flip()
            elif event.key == pygame.K_6:
                scaled_2 = pygame.transform.scale(image, (int(width * 0.35), height))
                rotozoom = pygame.transform.rotozoom(scaled_2, 180, 1)
                win.fill(CZARNY)
                win.blit(rotozoom, ((width - rotozoom.get_width()) // 2, (height - rotozoom.get_height()) // 2))
                pygame.display.flip()
            elif event.key == pygame.K_7:
                scaled_3 = pygame.transform.scale(image, (int(width * 0.5), height))
                flip = pygame.transform.flip(scaled_3, 1, 0)
                win.fill(CZARNY)
                win.blit(flip, ((width - flip.get_width()) // 2, (height - flip.get_height()) // 2))
                pygame.display.flip()
            elif event.key == pygame.K_8:
                scaled_4 = pygame.transform.scale(image, (width, int(height * 0.4)))
                ...
                scaled_5 = pygame.transform.scale(image, (int(width * 0.35), height))
